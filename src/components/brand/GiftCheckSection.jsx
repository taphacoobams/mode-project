  ...
  return (
    <section className="py-16">
      <motion.div
        ...
        className="bg-primary/10 p-8 md:p-12"
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-gray-700 mb-6">
              Offrez l'élégance I. K. MBENGUE à vos proches avec nos chèques cadeaux. 
          ...
          <div className="relative">
            <div className="absolute -top-4 -right-4 w-32 h-32 border-2 border-primary z-0"></div>
            <img 
              ...
              alt="Chèque cadeau I. K. MBENGUE" 
              className="w-full h-auto relative z-10 shadow-lg"
            />
            <div className="absolute -bottom-4 -left-4 w-32 h-32 border-2 border-primary z-0"></div>
          </div>
        </div>
      </motion.div>
    </section>
